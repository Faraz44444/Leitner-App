...
namespace Web0.Controllers.Report
{
    ...
    public class ReportsController : BaseController
    {
        ...
        public async Task<IActionResult> YearlyOverview([FromQuery] PaymentTotalRequest req)
        {
            ...
            var data = await ReportService.GetYearlyOverviewList(firstRecord.Date.StartOfDay(), lastRecord.Date.EndOfDay(), CurrentUser.CurrentClientId, CurrentUser.UserId);
            return Ok(Mapper.MapList<YearlyOverviewDto>(data));
        }
