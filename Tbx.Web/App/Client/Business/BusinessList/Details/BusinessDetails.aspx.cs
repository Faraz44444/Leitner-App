...
namespace TbxPortal.Web.App.Client.Business.BusinessList.Details
{
    public partial class BusinessDetails : TbxPortalBasePage
    {
        ...
        protected override void Page_Load(object sender, EventArgs e)
        {
            ...
            string redirectUrl = Page.ResolveUrl("~/category/list");
            if (entityId < 1)
            {
