<%@ Page Title="Article Details" Language="C#" MasterPageFile="~/TbxPortal.Master" AutoEventWireup="True" CodeBehind="BusinessDetails.aspx.cs" Inherits="TbxPortal.Web.App.Client.Business.BusinessList.Details.BusinessDetails" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <%: Scripts.Render("~/jsCategoryDetails") %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="breadCrumb" runat="server">
    ...
    <li><a href="<%=Page.ResolveUrl($"~/category/list/{EntityIdString}") %>"><%=EntityName %></a></li>
</asp:Content>
