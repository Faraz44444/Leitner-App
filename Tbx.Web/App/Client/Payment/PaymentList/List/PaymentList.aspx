<%@ Page Title="Payment List" Language="C#" MasterPageFile="~/TbxPortal.Master" AutoEventWireup="true" CodeBehind="PaymentList.aspx.cs" Inherits="TbxPortal.Web.App.Client.Payment.PaymentList.List.PaymentList" %>
