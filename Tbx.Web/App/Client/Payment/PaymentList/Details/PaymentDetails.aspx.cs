...
namespace TbxPortal.Web.App.Client.Payment.PaymentList.Details
{
    public partial class PaymentDetails : TbxPortalBasePage
    {
        ...
        protected override void Page_Load(object sender, EventArgs e)
        {
            ...
            //var entity = Services.PaymentService.GetById(entityId);
            //if (entity == null)
            //{
            //    Redirect(redirectUrl);
            //    return;
