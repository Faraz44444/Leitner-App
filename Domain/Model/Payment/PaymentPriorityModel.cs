...
{
    public class PaymentPriorityModel : PagedBaseModel
    {
        [IsTableColumn(true)]
        ...
        public PaymentPriorityModel() { }

        public PaymentPriorityModel(string name, long clientId, long createdByUserId,
            string createdByFirstName, string createdByLastName, bool deleted) : base(createdByUserId, createdByFirstName, createdByLastName)
        {
            Name = name;
            ClientId = clientId;
