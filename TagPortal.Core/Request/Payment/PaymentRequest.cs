...
namespace TagPortal.Core.Request.Payment
{
    public class PaymentRequest : BaseRequestPaged<PaymentOrderByEnum>
    {
    ...
    public enum PaymentOrderByEnum
    {
        Title = 1,
        BusinessName = 2,
        IsPaidToPerson = 3,
