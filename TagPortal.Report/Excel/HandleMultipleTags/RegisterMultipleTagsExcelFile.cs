...
{
    public class RegisterMultipleTagsExcelFile : BaseExcelFile
    {
            ...
            List<UnitModel> units, List<DestinationModel> destinations, List<TagModel> tags = null)
        {
            ...
            var groupedHeaderColumns = new List<TableGroupedHeaderDto> {
                new TableGroupedHeaderDto(0, 7, "General Information"),
                new TableGroupedHeaderDto(8, 10, "Maintenance"),
                new TableGroupedHeaderDto(11, 13, "Transport"),
                new TableGroupedHeaderDto(14, columns.Count - 1, "Additional Data")
            };
